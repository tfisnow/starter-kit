...
public class WebDriverWaits {
    ...
    private WebElement waitForElementVisibility(WebDriver driver, By locator)
        ...
        try {
            ...
            WebDriverWait wait = new WebDriverWait(driver,Integer.parseInt(FRAMEWORKPROPERTIES.getProperty(ELEMENTSEARCHTIMEOUT)));
    ...
    public Boolean waitForElementInVisibility(WebDriver driver, By locator)
            throws TimeoutException, WaitException {
        try {
            ...
            WebDriverWait wait = new WebDriverWait(driver,
                    Integer.parseInt(FRAMEWORKPROPERTIES.getProperty(ELEMENTSEARCHTIMEOUT)));
     ...
     */
   public void waitForEndOfAllAjaxes(WebDriver driver){
	   LOGGER.info(Utilities.getCurrentThreadId()
